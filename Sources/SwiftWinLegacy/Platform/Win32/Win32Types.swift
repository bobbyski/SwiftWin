...
let VK_RETURN: WPARAM = 0x0d
let VK_ESCAPE: WPARAM = 0x1b
let VK_PRIOR: WPARAM = 0x21
let VK_NEXT: WPARAM = 0x22
let VK_END: WPARAM = 0x23
let VK_HOME: WPARAM = 0x24
let VK_SHIFT: Int32 = 0x10
let VK_CONTROL: Int32 = 0x11
let VK_MENU: Int32 = 0x12
